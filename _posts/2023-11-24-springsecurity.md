...
```text
@RequestMapping("/hello") @PreAuthorize("@ex.hasAuthority('system:dept:list')")
 public String hello(){
      return "hello";
 }
```
...
![RBAC权限模型](https://cdn.jsdelivr.net/gh/zhongjunlee/image-store@main/images/RBAC%E6%9D%83%E9%99%90%E6%A8%A1%E5%9E%8B.jpg)
...
**AuthenticationEntryPoint** 对象的方法去进行异常处理。

如果是授权过程中出现的异常会被封装成AccessDeniedException然后调用

**AccessDeniedHandler**对象的方法去进行异常处理。
